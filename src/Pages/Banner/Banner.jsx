  ...
  return (
    <div className="w-full carousel">
      ...
      <div id="slide2" className="relative w-full carousel-item">
        <img src="/assets/images/banner/banner2.jpg" className="w-full" />
        <div className="absolute flex gap-5 transform right-5 bottom-5">
      ...
      <div id="slide3" className="relative w-full carousel-item">
        <img src="/assets/images/banner/banner3.jpg" className="w-full" />
        <div className="absolute flex gap-5 transform right-5 bottom-5">
          <a href="#slide2" className="btn btn-circle">
            ❮
          </a>
      ...
      <div id="slide4" className="relative w-full carousel-item">
        <img src="/assets/images/banner/banner4.jpg" className="w-full" />
        <div className="absolute flex gap-5 transform right-5 bottom-5">
          <a href="#slide3" className="btn btn-circle">
            ❮
          </a>
